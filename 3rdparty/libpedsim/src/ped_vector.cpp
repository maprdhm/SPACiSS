...
{
  return Ped::Tvector(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
}
...
// Warning: positive OR negative difference
...
{
  return Ped::Tvector(vector1In.x + vector2In.x, vector1In.y + vector2In.y, vector1In.z + vector2In.z);
}
