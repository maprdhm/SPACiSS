...
bool Ped::Tscene::removeAgent(Ped::Tagent* a)
{
  ...
  // Comment next line if use agents of type FROM_FILE.
  delete a;
...
void Ped::Tscene::getNeighbors(vector<const Ped::Tagent*>& neighborList, double x, double y, double dist) const
{
